...
static const XA_TrackDef xa_tracks[] = {
	...
	//WEEK1A.XA
	{XA_Week1A, XA_LENGTH(6700)}, //XA_Bopeebo
	{XA_Week1A, XA_LENGTH(7500)}, //XA_Fresh
	//WEEK1B.XA
	{XA_Week1B, XA_LENGTH(8300)},  //XA_Dadbattle
	{XA_Week1B, XA_LENGTH(4900)},  //XA_Tutorial
	//WEEK2A.XA
	{XA_Week2A, XA_LENGTH(8800)},  //XA_Spookeez
	{XA_Week2A, XA_LENGTH(8880)},  //XA_South
	//WEEK2B.XA
	{XA_Week2B, XA_LENGTH(17778)}, //XA_Monster
	{XA_Week2B, XA_LENGTH(11000)}, //XA_Clucked
	//WEEK3A.XA
	{XA_Week3A, XA_LENGTH(8000)},  //XA_Pico
	{XA_Week3A, XA_LENGTH(9800)},  //XA_Philly
	//WEEK3B.XA
	{XA_Week3B, XA_LENGTH(9200)}, //XA_Blammed
	//WEEK4A.XA
	{XA_Week4A, XA_LENGTH(7700)},  //XA_SatinPanties
	{XA_Week4A, XA_LENGTH(10600)}, //XA_High
	//WEEK4B.XA
	{XA_Week4B, XA_LENGTH(13500)}, //XA_MILF
	{XA_Week4B, XA_LENGTH(10300)}, //XA_Test
	//WEEK5A.XA
	{XA_Week5A, XA_LENGTH(10200)}, //XA_Cocoa
	{XA_Week5A, XA_LENGTH(9500)},  //XA_Eggnog
	//WEEK5B.XA
