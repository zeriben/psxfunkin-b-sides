...
static const char *funny_messages[][2] = {
	{"B-SIDES PORT BY ZERIBEN", "HELL YEAH"},
	{"ORIGINALLY PORTED BY CUCKYDEV", "WHAT YOU GONNA DO"},
	{"H SIDES ", "WHEN"},
	{"NO IM NOT PORTING", "GARCELLO"},
	{"FNF", "BUT COOLER"},
	{"WHAT IS", "FNF"},
	{"ROZEBUD", "ROZEBUD"},
	{"OPENGL BACKEND", "BY CLOWNACY"},
	{"WHAT IS A", "PLAYSTATION ACTUALLY"},
	{"I FUCKED UP THE", "SOURCE CODE THREE TIMES"},
	{"THANK", "LORD SCOUT"},
	{"MUKBANG MODE", "COMING"},
	...
	//Fallthrough
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_1, "ZERIBEN", false},
				{StageId_Kapi_2, "   B-SIDES PORT", false},				
				{StageId_Clwn_1, "Lord Scout", false},
				{StageId_Clwn_2, "   PLAYTESTING", false},
				{StageId_Clwn_1, "CUCKYDEV", false},
				{StageId_Kapi_2, "   FNF PS1 PORT", false},	
				{StageId_Clwn_1, "ROZEBUD", false},
				{StageId_Clwn_1, "   ORIGINAL B SIDES ", false},
				{StageId_Clwn_1, "CVAL AND JADS", false},
				{StageId_Clwn_1, "   ORIGINAL B SIDES ", false}				
